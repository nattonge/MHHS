...
```{r plct mhhs}
personal<-mhhs_data %>% select(ResponseId,GHSQ_RankPers_1:GHSQ_RankPers_9)
personal_demo<-mhhs_data %>% select(ResponseId,GHSQ_RankPers_1:GHSQ_RankPers_9,Race_Ethn2,BIC_1,GENDER,SEXOR,LANG_1)
personal<-personal[complete.cases(personal),]
personal_demo<-left_join(personal,personal_demo)
personal <- personal %>% select(-ResponseId)
...
## Sui
suic<-mhhs_data %>% select(ResponseId,GHSQO_RankSUI_1:GHSQO_RankSUI_9)
suic_demo<-mhhs_data %>% select(ResponseId,GHSQO_RankSUI_1:GHSQO_RankSUI_9,Race_Ethn2,BIC_1,GENDER,SEXOR,LANG_1)
suic<-suic[complete.cases(suic),]
suic_demo<-left_join(suic,suic_demo)
suic <- suic %>% select(-ResponseId)
